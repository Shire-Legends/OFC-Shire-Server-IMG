...
enum ShootType_t : uint8_t {
	...
	CONST_ANI_SHADOWBOLT = 23,
	CONST_ANI_PHANTOMBOLT = 24,
	...
	CONST_ANI_BIGEARTH = 38,
	CONST_ANI_ELEMENTALBOLT = 39,
	CONST_ANI_EARTHARROW = 40,
	CONST_ANI_EXPLOSION = 41,
	CONST_ANI_CAKE = 42,
	
	CONST_ANI_TARSALARROW = 44,
	CONST_ANI_BIGENERGY = 45,
	CONST_ANI_FIRE = 46,
