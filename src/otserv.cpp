...
void printServerVersion()
{
	...
	std::cout << R"(
 _______        ________________ _______    _       _______ _______ _______ _       ______  _______ 
(  ____ \      /\__   __(  ____ \(  ____ \  ( \     (  ____ (  ____ (  ____ ( (    /(  __  \(  ____ \
| (    \/ )   ( |  ) (  | (    )| (    \/  | (     | (    \/ (    \/ (    \/  \  ( | (  \  ) (    \/
| (_____| (___) |  | |  | (____)| (__      | |     | (__   | |     | (__   |   \ | | |   ) | (_____ 
(_____  )  ___  |  | |  |     __)  __)     | |     |  __)  | | ____|  __)  | (\ \) | |   | (_____  )
      ) | (   ) |  | |  | (\ (  | (        | |     | (     | | \_  ) (     | | \   | |   ) |     ) |
/\____) | )   ( |__) (__| ) \ \_| (____/\  | (____/\ (____/\ (___) | (____/\ )  \  | (__/  )\____) |
\_______)/     \_______//   \__(_______/  (_______(_______(_______|_______//    )_|______/\_______)
)" << std::endl;
}
