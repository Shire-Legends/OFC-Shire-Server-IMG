...
OutputMessage_ptr OutputMessagePool::getOutputMessage() {
    // Usar std::allocate_shared com LockfreePoolingAllocator
    return std::allocate_shared<OutputMessage>(
        typename LockfreePoolingAllocator<void, OUTPUTMESSAGE_FREE_LIST_CAPACITY>::template rebind<OutputMessage>::other()
    );
}
