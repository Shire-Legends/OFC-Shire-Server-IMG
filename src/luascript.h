...
class LuaScriptInterface
{
	...
	private:
		...
		// Reset
		static int32_t luaGetPlayerReset(lua_State* L);
		static int32_t luaSetPlayerReset(lua_State* L);
		static int32_t luaDoResetLevel(lua_State* L);
		...
		static int luaPlayerAddMaxHealth(lua_State* L);
		static int luaPlayerAddMagicLevel(lua_State* L);
		static int luaPlayerAddSkillLevel(lua_State* L);
		//static int luaPlayerAdd	(lua_State* L);
		...
		static int luaPlayerKickPlayer(lua_State* L);
