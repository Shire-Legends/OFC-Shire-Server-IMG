...
std::string formatDate(time_t time)
{
	...
	char buffer[20];
	int res = snprintf(buffer, sizeof(buffer), "%02d/%02d/%04d %02d:%02d:%02d",
...
ShootTypeNames shootTypeNames = {
	...
	{"shadowbolt",		CONST_ANI_SHADOWBOLT},
	{"phantombolt",	CONST_ANI_PHANTOMBOLT},
...
AmmoTypeNames ammoTypeNames = {
	...
	{"shadowbolt",		AMMO_BOLT},
	{"phantombolt",		AMMO_BOLT},
	{"elementalbolt",	AMMO_BOLT},
	{"bullet",			AMMO_BULLET}
};
...
const char* getReturnMessage(ReturnValue value)
{
	...
	case RETURNVALUE_NOTATTACKTHISPLAYERGUILD:
		return "You can't attack members of the same guild";
