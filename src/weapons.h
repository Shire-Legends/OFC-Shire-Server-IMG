...
class Weapons final : public BaseEvents
{
	public:
		...
		static int32_t getMaxWeaponDamageForm(int32_t attackSkill, int32_t attackValue,float attackFactor );
		static int32_t getMinWeaponDamageForm(int32_t attackSkill, int32_t attackValue,float attackFactor);

		static int32_t getMaxWeaponAmmoDamage(int32_t attackSkill, int32_t attackValue, float attackFactor);
		static int32_t getMinWeaponAmmoDamage(int32_t attackSkill, int32_t attackValue, float attackFactor);
