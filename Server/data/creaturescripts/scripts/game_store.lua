...
function init()
  ...
  local category1 = addCategory({
    type="item",
    item=ItemType(6527):getClientId(),
    count=1,
    name="Market"
  })
  ...
  category1.addItem(100, 6527, 100, "100 Shire Legends Points", "Moedas utilizadas para compra de utilitarios com o Mark.")
  category1.addItem(20, 14997, 100, "100 Great Mana Fluids", "Poção grande de mana.")
  category1.addItem(60, 14998, 20, "20 Great Blood of God\'s", "Sangue dos deuses.")
  category1.addItem(30, 14994, 10, "10 Teleports", "Teleportar de uma cidade para outra.")
  category1.addItem(20, 15009, 1, "Energético", "Item utilizado para recuperar stamina.")
  category1.addItem(60, 15004, 1, "Fighting Spirit", "Item utilizado para dobrar a experience.")
  category1.addItem(25, 13692, 1, "Captive Soul", "Item utilizado para ganhar soul.")
  category1.addItem(15, 2267, 200, "200 Dark SDs", "Adori vita dark.")
  category1.addItem(15, 2314, 400, "400 Dark Explosions", "Adevo mas hur dark.")
  category1.addItem(15, 2268, 200, "SDs", "Adori vita vis.")
  category1.addItem(15, 2313, 400, "Explosions", "Adevo mas hur.")
  category1.addItem(15, 2273, 200, "UHs", "Adura vita.")
  category1.addItem(15, 2293, 300, "Magic walls", "Adevo Grav Tera.")
  category1.addItem(15, 2261, 300, "Destroy Fields", "Adito Grav.")
  ...
  -- category2.addOutfit(500, {
    ...
    -- category3.addImage(10000, "/data/images/game/states/haste.png", "Offer with local image", "another local image\n/data/images/game/states/haste.png")
    -- category3.addImage(10000, "http://otclient.ovh/images/freezing.png", "Offer with remote image and custom buy action", "blalasdasd image\nhttp://otclient.ovh/images/freezing.png", customImageBuyAction)
end
