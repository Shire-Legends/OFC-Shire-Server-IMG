...
combat:setFormula(COMBAT_FORMULA_LEVELMAGIC, -0.5, 0, -0.8, 0)
...
combat2:setFormula(COMBAT_FORMULA_LEVELMAGIC, -0.8, 0, -1.2, 0)
...
if rand == 10 then
doCreatureSay(creature, "Novice.Explo!", TALKTYPE_ORANGE_1)
