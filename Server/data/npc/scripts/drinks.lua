...
local voices = { {text = "drinks, lemonade, fruit juice, beer and wine! Have a look!"} }
...
local function showOffers(player)
    npcHandler:say("aqui está alguns dos itens que eu vendo: lemonade, fruit juice, beer, milk, coconut, wine, rum", player)
end
