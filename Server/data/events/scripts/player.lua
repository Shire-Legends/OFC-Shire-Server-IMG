...
function Player:onMoveItem(item, count, fromPosition, toPosition, fromCylinder, toCylinder)
	if hasEventCallback(EVENT_CALLBACK_ONMOVEITEM) then
		for i = 0, 255 do
			local pos = getThingfromPos({x=toPosition.x, y=toPosition.y, z=toPosition.z, stackpos=i})
			if pos.itemid == 1777 or pos.itemid == 4608 or pos.itemid == 4609 or pos.itemid == 4623 or pos.itemid == 4615 then

				if(pos.itemid ~= 1777)then
